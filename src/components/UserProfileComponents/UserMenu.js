            ...
            <div className="leftPartUserDetail">
                ...
                <div className="row">
                    {/* <div className="mr-20 col-12"><p>
                        <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M19 21.0002V18.7779C19 17.5992 18.5259 16.4687 17.682 15.6352C16.8381 14.8017 15.6935 14.3335 14.5 14.3335H5.5C4.30653 14.3335 3.16193 14.8017 2.31802 15.6352C1.47411 16.4687 1 17.5992 1 18.7779V21.0002" stroke={myActive==="labelPointer"?"#5B5B5B":"#FF7062"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M10 9.88889C12.4853 9.88889 14.5 7.89904 14.5 5.44444C14.5 2.98985 12.4853 1 10 1C7.51472 1 5.5 2.98985 5.5 5.44444C5.5 7.89904 7.51472 9.88889 10 9.88889Z" stroke={myActive==="labelPointer"?"#5B5B5B":"#FF7062"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                                    &nbsp; Hồ sơ của tôi</p>
                    </div>
                    <div className="mr-20 col-12"><p>
                    ...
                    <div className="mr-20 col-12"><p>
                        <svg width="21" height="26" viewBox="0 0 21 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M15.25 14.0625H5.75" stroke={myActive==="labelPointer"?"#5B5B5B":"#FF7062"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M15.25 18.8125H5.75" stroke={myActive==="labelPointer"?"#5B5B5B":"#FF7062"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M8.125 9.3125H6.9375H5.75" stroke={myActive==="labelPointer"?"#5B5B5B":"#FF7062"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                                    &nbsp; Đặt chỗ của tôi</p>
                    </div>
                    <div className="mr-20 col-12"><p>
                        <svg width="24" height="26" viewBox="0 0 24 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20.2 11.7998H3.4C2.07452 11.7998 1 12.8743 1 14.1998V22.5998C1 23.9253 2.07452 24.9998 3.4 24.9998H20.2C21.5255 24.9998 22.6 23.9253 22.6 22.5998V14.1998C22.6 12.8743 21.5255 11.7998 20.2 11.7998Z" stroke={myActive==="labelPointer"?"#5B5B5B":"#FF7062"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M5.80078 11.8V7C5.80078 5.4087 6.43292 3.88258 7.55814 2.75736C8.68336 1.63214 10.2095 1 11.8008 1C13.3921 1 14.9182 1.63214 16.0434 2.75736C17.1686 3.88258 17.8008 5.4087 17.8008 7V11.8" stroke={myActive==="labelPointer"?"#5B5B5B":"#FF7062"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                                     &nbsp; Đổi mật khẩu</p>
                    </div>
               */}
