...
class UserOrderDetail extends Component {
    ...
    showOrderByStatus = (orderDetail) => {
                    ...
                    <div className="row">
                        ...
                        <div className="col-4" >
                            <svg className="svgLG" width="110" height="110" viewBox="0 0 110 110" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M75.9336 45.4092H78.9919C82.2364 45.4092 85.348 46.6981 87.6423 48.9923C89.9365 51.2865 91.2253 54.3981 91.2253 57.6426C91.2253 60.8871 89.9365 63.9987 87.6423 66.2929C85.348 68.5871 82.2364 69.876 78.9919 69.876H75.9336" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M27 45.4092H75.9336V72.9343C75.9336 76.1788 74.6447 79.2904 72.3505 81.5846C70.0563 83.8788 66.9447 85.1677 63.7002 85.1677H39.2334C35.9889 85.1677 32.8773 83.8788 30.5831 81.5846C28.2889 79.2904 27 76.1788 27 72.9343V45.4092Z" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M39.2344 24V33.175" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M51.4668 24V33.175" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M63.6992 24V33.175" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                        <div className="col-4" >
        ...
        if (orderStatus === "UNPAID") {
            // <svg style={{ visibility: orderDetail.status === "UNPAID" ? "visible" : "hidden" }} width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
            //     <circle cx="55" cy="55" r="55" fill="#FF7062" />
            //     <path d="M36 68C53.6731 68 68 53.6731 68 36C68 18.3269 53.6731 4 36 4C18.3269 4 4 18.3269 4 36C4 53.6731 18.3269 68 36 68Z" stroke="white" stroke-width="7" stroke-linecap="round" stroke-linejoin="round" />
            //     <path d="M36 17V35.75L49 42" stroke="white" stroke-width="7" stroke-linecap="round" stroke-linejoin="round" />
            // </svg>
            return (
                <div style={{ padding: "20px" }}>
                    <div id="inline">
        ...
        if (orderStatus === "SENT") {
            // <svg style={{ visibility: orderDetail.status === "SENT" ? "visible" : "hidden" }} width="110" height="110" viewBox="0 0 110 110" fill="none" xmlns="http://www.w3.org/2000/svg">
            //     <circle cx="55" cy="55" r="55" fill="#19CF78" />
            //     <path d="M90.1965 34.375L44.2984 80.2732L23.4355 59.4104" stroke="white" stroke-width="10" stroke-linecap="round" stroke-linejoin="round" />
            // </svg>
            return (
                <p>Chưa viết</p>
            )
        ...
        if (orderStatus === "EXPIRED") {
            // <svg style={{ visibility: orderDetail.status === "EXPIRED" ? "visible" : "hidden" }} width="110" height="110" viewBox="0 0 110 110" fill="none" xmlns="http://www.w3.org/2000/svg">
            //     <circle cx="55" cy="55" r="55" fill="#E3E3E3" />
            //     <path d="M54.8145 85.6289C71.8328 85.6289 85.6289 71.8328 85.6289 54.8145C85.6289 37.7961 71.8328 24 54.8145 24C37.7961 24 24 37.7961 24 54.8145C24 71.8328 37.7961 85.6289 54.8145 85.6289Z" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
            //     <path d="M42.4883 64.0586H67.1398" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
            //     <path d="M45.5703 45.5703H45.6018" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
            //     <path d="M64.0586 45.5703H64.0901" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
            // </svg>
            return (
                <p>Chưa viết</p>
            )
